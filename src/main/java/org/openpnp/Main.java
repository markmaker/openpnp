...
public class Main {
    public static String getVersion() {
        ...
        if (version == null) {
            ...
            version = "INTERNAL BUILD "+df.format(buildDate);
        }
        return version;
    }
     ...
     * From: https://stackoverflow.com/a/22404140/15218951 CC BY-SA 3.0
    ...
    /**
     * @return the build date of the OpenPnP Main class.
     */
